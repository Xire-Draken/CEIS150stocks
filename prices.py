...
full_name = str(input("What is your name? ").strip())
...
#the ouput could also be written by this example too.
#This way is better looking and easier to read in my opinion
#also 
